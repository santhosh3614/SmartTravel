...
import com.transpo.utils.MmtsTrainStationListCSVFileReader;

import java.util.ArrayList;
import java.util.List;

public class MmtsTrainSearchActivity extends AppCompatActivity implements View.OnClickListener {

    private AutoCompleteTextView fromAutoCompleteTextView;
    private AutoCompleteTextView toAutoCompleteTextView;
    private Button searchButton;
    private List<MmtsTrainStationInfo> allLocationRoutesList;
    private ArrayList fromLocationRoutesList;
    private ArrayList toLocationRotesList;
    private ArrayAdapter<MmtsTrainStationInfo> frmLocRouteAdapter;
    private ArrayAdapter<MmtsTrainStationInfo> toLocRouteAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_metro_train_search);
        ...
        MmtsTrainStationListCSVFileReader routesListCSVFileReader = new MmtsTrainStationListCSVFileReader(getResources()
                .openRawResource(R.raw.mmts_latlong));
    ...
    public void onClick(View v) {
        if (fromLocation != null && toLocation != null) {
            Intent intent = new Intent(this, MetroTrainListActivity.class);
